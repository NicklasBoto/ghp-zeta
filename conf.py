...
BLOG_AUTHOR = "Nicklas Botö"  # (translatable)
BLOG_TITLE = "The Zeta Calculus"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://zeta.nicbot.xyz/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://zeta.nicbot.xyz/"
BLOG_EMAIL = "boton@chalmers.se"
BLOG_DESCRIPTION = "Collected writings and ongoing work on the zeta calculus."  # (translatable)
